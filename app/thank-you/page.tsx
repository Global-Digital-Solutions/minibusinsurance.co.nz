  ...
  return (
    <section className="min-h-[60vh] flex items-center justify-center py-20">
      <div className="max-w-lg mx-auto px-4 text-center">
        ...
        <h1 className="text-3xl font-bold text-[#136771] mb-4">Enquiry Received!</h1>
        <p className="text-gray-600 text-lg mb-6">Thank you for getting in touch. A licensed New Zealand minibus insurance adviser will contact you within one business day to discuss your needs and present cover options.</p>
        <div className="bg-[#136771]/5 border border-[#136771]/20 rounded-2xl p-5 mb-8 text-left">
          <h2 className="font-semibold text-[#136771] mb-3">What happens next?</h2>
          <div className="space-y-3">
            {['An adviser on our panel will review your enquiry', 'They will contact you by phone or email — usually within 1 business day', 'They will assess your specific needs and present cover options', 'You decide whether to proceed — no obligation at any stage'].map((step, i) => (
              <div key={i} className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-[#136771] text-white text-xs font-bold flex items-center justify-center flex-shrink-0">{i + 1}</div>
